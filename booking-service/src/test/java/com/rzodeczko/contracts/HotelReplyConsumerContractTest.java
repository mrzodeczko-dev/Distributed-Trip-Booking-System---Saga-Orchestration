 ...
 * deserializuje wiadomosci zdefiniowane w kontraktach hotel-service.
 */
@SpringBootTest(
        classes = HotelReplyConsumerContractTest.TestConfig.class,
        webEnvironment = SpringBootTest.WebEnvironment.NONE
)
@AutoConfigureMessageVerifier
@AutoConfigureStubRunner(
        ids = "com.rzodeczko:hotel-service:0.0.1:stubs",
        stubsMode = StubRunnerProperties.StubsMode.LOCAL
)
class HotelReplyConsumerContractTest {
    ...
    void shouldDeserializeSuccessReplyOnReserve() throws Exception {
        stubTrigger.trigger("hotel_reserve_success");
    ...
    void shouldDeserializeFailureReplyOnReserve() throws Exception {
        stubTrigger.trigger("hotel_reserve_failure");
    ...
    void shouldDeserializeSuccessReplyOnCancel() throws Exception {
        stubTrigger.trigger("hotel_cancel_success");
