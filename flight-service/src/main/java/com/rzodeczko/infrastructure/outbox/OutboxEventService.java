...
/**
 * Zapisuje event do Outboxa. Propagation.MANDATORY wymusza istniejaca transakcje -
 * odpowiedz powstaje atomowo razem z rezerwacja/anulowaniem i wpisem idempotencji.
 */
@Slf4j
@Service
